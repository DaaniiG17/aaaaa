...
<body>
    ...
    <h1 class="mt-5">PORTEROS</h1>
        ...
        <div class="row text-center">
            <div class="col-lg-4 mb-5">
                ...
                <h5>2 goles</h5>
                <button class="btn btn-secondary bg-primary cambiarNumeroGoles">Cambiar número de goles</button>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4 mb-5">
    ...
    <script>
        ...
        <button type="submit" class="btn btn-primary">Cambiar goles</button>
        `;
                ...
                boton.addEventListener('click', cambiarNumeroGoles)

                function cambiarNumeroGoles(e){

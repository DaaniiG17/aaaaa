...
<body>
    ...
    <div class="container marketing">
        ...
        <div class="row text-center">
            <div class="col-lg-4 mb-5">
                ...
                <h5>2 temporadas</h5>
                <button class="btn btn-secondary bg-primary cambiarNumeroTemporadas">Cambiar numero de temporadas</button>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4 mb-5">
    ...
    <script>
        ...
        `;
                ...
                boton.addEventListener('click', cambiarNumeroTemporadas)

                function cambiarNumeroTemporadas(e){

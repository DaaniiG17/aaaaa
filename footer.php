...
<div class="bg-primary">
    <footer class="py-3">
        <ul class="nav justify-content-center">
            ...
            <li class="nav-item"><a href="asistencias.php" class="nav-link text-white">Asistencias</a></li>
            <li class="nav-item"><a href="amarillas.php" class="nav-link text-white">Tarjetas amarillas</a></li>
            <li class="nav-item"><a href="rojas.php" class="nav-link text-white">Tarjetas rojas</a></li>
            <li class="nav-item"><a href="temporadas.php" class="nav-link text-white">Temporadas en el club</a></li>
        </ul>

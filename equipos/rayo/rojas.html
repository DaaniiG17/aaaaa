...
<body>
    ...
    <div class="container marketing">
        ...
        <div class="row text-center">
            <div class="col-lg-4 mb-5">
                ...
                <h5>1 rojas</h5>
                <button class="btn btn-secondary bg-primary cambiarNumeroRojas">Cambiar numero de rojas</button>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4 mb-5">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function (e) {
            ...
            const botonCambiarPartidos = document.querySelectorAll('.cambiarNumeroRojas');
        ...
        <input type="text" class="form-control mb-3" id="cantidadRojasNueva" style="width: 250px;" required>
        ...
        `;
                ...
                boton.addEventListener('click', cambiarNumeroRojas)

                function cambiarNumeroRojas(e){
                    let numeroPartidosNuevo = formulario.querySelector('#cantidadRojasNueva').value;

...
<body>
    ...
    <div class="container marketing">
        ...
        <div class="row text-center">
            <div class="col-lg-4 mb-5">
                ...
                <h2>Álvaro Valles</h2>
                <h5>Portero</h5>
                <button class="btn btn-secondary bg-primary cambiarNumeroAsistencias">Cambiar numero asistencias</button>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4 mb-5">
    ...
    <script>
        ...
        <input type="text" class="form-control mb-3" id="cambiarAsistenciasNueva" style="width: 250px;" required>
        ...
        `;
                ...
                function cambiarNumeroPartidos(e){
                    let numeroPartidosNuevo = formulario.querySelector('#cambiarAsistenciasNueva').value;

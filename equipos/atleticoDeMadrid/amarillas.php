        ...
        <div class="container marketing">
            ...
            <div class="row text-center">
                <div class="col-lg-4 mb-5">
                    ...
                    <h2>Jan Oblak</h2>
                    <h5>2 amarillas</h5>
                    <button class="btn btn-secondary bg-primary cambiarNumeroAmarillas">Cambiar número de
                        amarillas</button>
                </div><!-- /.col-lg-4 -->
                <div class="col-lg-4 mb-5">
            ...
            <div class="row text-center" id="defensa">
                ...
                <div class="col-lg-4">
                    <img class="rounded-circle" width="140" height="140"
                        src="../../jugadores/atleti/cesarAzpilicueta.png">
                    </img>
            ...
            <div class="row text-center" id="mediocentros">
                ...
                <div class="row">
                    <div class="col-lg-4 mb-5">
                        <img class="rounded-circle" width="140" height="140"
                            src="../../jugadores/atleti/thomasLemar.png">
                        </img>
                        <h2>Thomas Lemar</h2>
                        <h5>0 amarillas</h5>
                        <button class="btn btn-secondary bg-primary cambiarNumeroAmarillas">Cambiar número de
                    ...
                    <div class="col-lg-4 mb-5">
                        <img class="rounded-circle" width="140" height="140"
                            src="../../jugadores/atleti/marcosLlorente.png">
                        </img>
                    ...
                    <div class="col-lg-4 mb-5">
                        <img class="rounded-circle" width="140" height="140"
                            src="../../jugadores/atleti/rodrigoRiquelme.png">
                        </img>
                    ...
                    <div class="col-lg-4 mb-5">
                        <img class="rounded-circle" width="140" height="140"
                            src="../../jugadores/atleti/axelWitsel.png">
                        </img>
                        <h2>Axel Witsel</h2>
                        <h5>5 amarillas</h5>
                        <button class="btn btn-secondary bg-primary cambiarNumeroAmarillas">Cambiar número de
                    ...
                    <div class="col-lg-4 mb-5">
                        <img class="rounded-circle" width="140" height="140"
                            src="../../jugadores/atleti/pabloBarrios.png">
                        </img>
                        <h2>Pablo Barrios</h2>
                        <h5>Mediocentro</h5>
                ...
                <div class="row text-center" id="delantero">
                    <div class="col-lg-4 mb-5">
                        <img class="rounded-circle" width="140" height="140"
                            src="../../jugadores/atleti/antoineGrizzman.png">
                        </img>
                    ...
                    <div class="col-lg-4 mb-5">
                        <img class="rounded-circle" width="140" height="140"
                            src="../../jugadores/atleti/memphisDepay.png">
                        </img>
                    ...
                    <div class="col-lg-4 mb-5">
                        <img class="rounded-circle" width="140" height="140"
                            src="../../jugadores/atleti/angelCorrea.png">
                        </img>
                    ...
                    <div class="col-lg-4 mb-5">
                        <img class="rounded-circle" width="140" height="140"
                            src="../../jugadores/atleti/alvaroMorata.png">
                        </img>
    ...
    <div class="bg-primary">
        <footer class="py-3">
            <ul class="nav justify-content-center">
                <li class="nav-item"><a href="atleticoDeMadrid.html" class="nav-link text-white">Plantilla</a>
                </li>
                <li class="nav-item"><a href="estadio.html" class="nav-link text-white">Estadio</a></li>
                <li class="nav-item"><a href="partidosJugados.html" class="nav-link text-white">Partidos
                        jugados</a></li>
                ...
                <li class="nav-item"><a href="amarillas.html" class="nav-link text-white">Tarjetas amarillas</a>
                </li>
                <li class="nav-item"><a href="rojas.html" class="nav-link text-white">Tarjetas rojas</a></li>
                <li class="nav-item"><a href="temporadas.html" class="nav-link text-white">Temporadas en el
                        club</a></li>
            </ul>

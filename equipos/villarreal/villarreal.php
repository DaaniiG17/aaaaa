...
<body>
    ...
    <div class="container marketing">
        ...
        <div class="row mt-5 d-flex justify-content-center">
            ...
            <div class="col-lg-4 text-center">
                <img class="rounded-circle" width="140" height="140"
                    src="../../entrenadores/imgEntrenadores/entrenadorVillarreal.png">
                </img>
        ...
        <div class="row text-center">
            ...
            <div class="col-lg-4 mb-5">
                <img class="rounded-circle" width="140" height="140"
                    src="../../jugadores/villarreal/filipJorgensen.png">
                </img>
        ...
        <div class="row text-center" id="mediocentros">
            ...
            <div class="col-lg-4 mb-5">
                <img class="rounded-circle" width="140" height="140"
                    src="../../jugadores/villarreal/francisCoquelin.png">
                </img>
            ...
            <div class="col-lg-4 mb-5">
                <img class="rounded-circle" width="140" height="140"
                    src="../../jugadores/villarreal/alfonsoPedraza.png">
                </img>
        ...
        <div class="row text-center" id="delantero">
            ...
            <div class="col-lg-4 mb-5">
                <img class="rounded-circle" width="140" height="140"
                    src="../../jugadores/villarreal/alexanderSorloth.png">
                </img>
            ...
            <div class="col-lg-4 mb-5">
                <img class="rounded-circle" width="140" height="140"
                    src="../../jugadores/villarreal/joseLuisMorales.png">
                </img>

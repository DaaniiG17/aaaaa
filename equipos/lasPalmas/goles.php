...
<body>
    ...
    <div class="container marketing">
        ...
        <div class="row text-center">
            <div class="col-lg-4 mb-5">
                ...
                <h2>Álvaro Valles</h2>
                <h5>0 goles</h5>
                <button class="btn btn-secondary bg-primary cambiarNumeroPartidos">Cambiar numero de goles</button>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4 mb-5">
    ...
    <script>
        ...
        <button type="submit" class="btn btn-primary">Cambiar numero de goles</button>
        `;

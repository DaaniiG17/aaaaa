    ...
    <div class="container marketing mb-5">
        ...
        <div class="row mt-5 d-flex justify-content-center" id="estadio">
            <div class="col-lg-4 text-center">
                ...
                <h2 id="nombreEstadio">Estadio Santiago Bernabéu</h2>
        ...
        <div class="d-flex  justify-content-center mt-5">
            <img src="../../estadios/imgestadios/estadiorealmadrid.webp" id="imagenEstadio" alt="" class="rounded-4" style="width: 100%;">
        </div>
    </div>

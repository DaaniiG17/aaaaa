                ...
                <ul class="navbar-nav me-auto mb-2 mb-sm-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdown03">
                            ...
                            <li><a class="dropdown-item" href="temporadas.html">Tarjetas temporadas</a></li>
    ...
    <div class="bg-primary">
        <footer class="py-3">
            <ul class="nav justify-content-center">
                ...
                <li class="nav-item"><a href="temporadas.html" class="nav-link text-white">Tarjetas temporadas</a></li>

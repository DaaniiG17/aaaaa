...
<body>
    ...
    <div class="container marketing">
        ...
        <div class="row text-center">
            <div class="col-lg-4 mb-5">
                ...
                <h5>0 asistencias</h5>
                <button class="btn btn-secondary bg-primary cambiarNumeroAsistencias">Cambiar numero de asistencias</button>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4 mb-5">
    ...
    <script>
        ...
        <input type="text" class="form-control mb-3" id="cantidadAsistenciasNueva" style="width: 250px;" required>
        ...
        `;
                ...
                boton.addEventListener('click', cambiarNumeroAsistencias)

                function cambiarNumeroAsistencias(e){
                    let numeroPartidosNuevo = formulario.querySelector('#cantidadAsistenciasNueva').value;

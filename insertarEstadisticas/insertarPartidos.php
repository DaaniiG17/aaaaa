    ...
    if ($equipo) {
        ...
        if (count($result) > 0) {
            ...
            foreach($result as $row) {
                ...
                echo '<br>';
                echo '<h5>' . $row["posicion"] . '<br>  Partidos Jugados: ' . $row["partidosJugados"] . '</h5>';
                echo '<button class="btn btn-secondary bg-primary cambiarNumeroPartidos">Cambiar numero partidos</button>';
                echo '</div><!-- /.col-lg-4 -->';
            }

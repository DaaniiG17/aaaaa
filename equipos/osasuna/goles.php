...
<body>
    ...
    <div class="container marketing">
        ...
        <div class="row text-center">
            <div class="col-lg-4 mb-5">
                ...
                <h5>Portero</h5>
                <button class="btn btn-secondary bg-primary cambiarNumeroGoles">Cambiar goles</button>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4 mb-5">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function (e) {
            ...
            const botonCambiarPartidos = document.querySelectorAll('.cambiarNumeroGoles');
        ...
        <label for="posicionJugador" class="form-label">Escribe la cantidad de goles</label>
        <input type="text" class="form-control mb-3" id="cantidadGolesNueva" style="width: 250px;" required>
        ...
        `;
                ...
                function cambiarNumeroPartidos(e){
                    let numeroPartidosNuevo = formulario.querySelector('#cantidadGolesNueva').value;
                    nuevosPartidos.innerHTML = `
                    ${numeroPartidosNuevo} goles
                    `
                }
